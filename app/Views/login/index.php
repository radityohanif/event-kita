            ...
            <div class="container">
                ...
                <form class="row align-middle justify-content-center" action="<?= base_url('login/process'); ?>" method="POST" autocomplete="off">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control rounded-pill py-2" id="username" name="username" placeholder="Ketik username" autofocus required value="<?= old('username'); ?>" />
                    </div>
                    <div class="form-group mb-4">
                        <label for="password" class="mb-2">Password</label>
                        <input type="password" class="form-control rounded-pill py-2" id="password" name="password" placeholder="Masukkan password" required value="<?= old('password'); ?>" />
                    </div>
