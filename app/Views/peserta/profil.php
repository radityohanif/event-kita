...
<body class="bg-kuning">
    ...
    <div class="row mt-1 justify-content-center">
        <div class="col text-center">
            <img src="<?= base_url('/img/foto profil/' . $_SESSION['user']['gambar_profil']); ?>" alt="foto profil saya"
            ...
            <div class="col-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="ttl"
                        placeholder="<?= $_SESSION['user']['tanggal_lahir']; ?>" />
                </div>
            </div>
            <div class="col-4">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nohp"
                        placeholder="<?= $_SESSION['user']['no_hp']; ?>" />
                </div>
                <div class="mb-3">
                    <label for="jk" class="form-label">Jenis Kelamin</label>
                    <input type="text" class="form-control" id="jk" placeholder="<?= $_SESSION['user']['jk']; ?>" />
                </div>
                <!-- </form> -->
            </div>
        </div>
