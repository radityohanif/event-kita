...
<body class="bg-kuning">
  ...
  <?php  if($validator->hasError('foto')): ?>
  ...
  <div class="row mt-1 justify-content-center">
    <div class="col text-center">
      <img src="<?= base_url('/img/foto profil/' . $profil['gambar_profil']); ?>" alt="foto profil saya" width="200" class="img-fluid rounded-circle shadow" />
    </div>
  ...
  <div class="row mt-5 justify-content-center">
    <div class="col-4">
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control" id="ttl" value="<?= $profil['tanggal_lahir']; ?>" name="tgl" />
      </div>
    </div>
    <div class="col-4">
      <div class="mb-3">
        <label for="username" class="form-label">Username</label>
        <input type="text" class="form-control" id="username" value="<?= $profil['username']; ?>" name="username" disabled />
      </div>
      <div class="mb-3">
        <label for="nohp" class="form-label">Nomor HP</label>
        <input type="number" class="form-control" id="nohp" value="<?= $profil['no_hp']; ?>" name="nomorhp" />
      </div>
      <div class="mb-3">
