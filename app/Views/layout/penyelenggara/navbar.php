      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li>
              <a class="dropdown-item" href="<?= base_url('/penyelenggara/profil'); ?>">Lihat Profil</a>
            </li>
            <li><a class="dropdown-item" href="myEvent.html">Event Saya</a></li>
            <li><a class="dropdown-item" href="<?= base_url('penyelenggara/pengajuan'); ?>">Pengajuan Event</a></li>
            <li>
