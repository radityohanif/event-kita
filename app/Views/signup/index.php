                ...
                <form class="row justify-content-center" action="<?= base_url('signup/process'); ?>" method="POST" autocomplete="off">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control rounded-pill py-2" placeholder="Masukkan nama anda" id="nama" name="nama" autofocus value="<?= old('nama'); ?>" />
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control rounded-pill py-2" placeholder="Masukkan email anda" id="email" name="email" value="<?= old('email'); ?>" />
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control rounded-pill py-2" placeholder="Masukkan username baru" id="username" name="username" value="<?= old('username'); ?>" />
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Password</label>
                            <input type="password" class="form-control rounded-pill py-2" placeholder="Masukkan password" id="password" name="password" value="<?= old('password'); ?>" />
                        </div>
                        <div class="mb-3">
                            <label for="konfirmasi" class="form-label">Konfirmasi Password</label>
                            <input type="password" class="form-control rounded-pill py-2" placeholder="Masukkan kembali password" id="konfirmasi" name="konfirmasi_password" value="<?= old('konfirmasi_password'); ?>" />
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-4">
